...
echo ""
echo "  5. (Optional) Deploy test agents for E2E testing:"
echo "     # Deploy static manifests (fast)"
echo "     kubectl apply -f components/03-applications/agents/"
echo ""
echo "     # OR use dynamic import via AgentBuild CRDs (uses Tekton pipelines)"
echo "     ./scripts/import-agents-via-kagenti.sh \\"
echo "       \"https://github.com/redhat-et/agent-examples.git\" \\"
echo "       \"a2a/weather_service\" \\"
echo "       \"weather-agent\" \\"
echo "       \"team1\""
echo ""
